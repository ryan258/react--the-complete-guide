...
// - the real logic resides in the parent component, and there ExpensesFilter becomes what is called a controlled component, where the value and changes to the value are not handled in the component itself, but the parent component
